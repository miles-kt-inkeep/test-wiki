...
- [Mercury Lounge](../../neighborhoods/lower-east-side/venues/mercury-lounge.md) — the 250-capacity Houston Street room where the Strokes, Interpol, and Yeah Yeah Yeahs all played early residencies.
- [Bowery Ballroom](../../neighborhoods/lower-east-side/venues/bowery-ballroom.md) — the 575-capacity Delancey Street venue that became the scene's graduation hall.
- [CBGB](../../neighborhoods/lower-east-side/venues/cbgb.md) — still standing through 2006, hosted many of the bands that explicitly invoked its history.
...
- [Bowery Ballroom](../../neighborhoods/lower-east-side/venues/bowery-ballroom.md)
- [HOME](../../HOME.md)
